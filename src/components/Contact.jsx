...
import { Mail, Linkedin, Github, Smartphone, MapPin, Code } from 'lucide-react';
...
const Contact = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    formData.append("access_key", "b29a03a4-f130-46da-9b1e-b810a3d9bf50");
  ...
  const socialLinks = [
    { icon: <Github size={24} />, url: 'https://github.com/mohinpt' },
    { icon: <Linkedin size={24} />, url: 'https://www.linkedin.com/in/themohin' },
    { icon: <Code size={24} />, url: 'https://leetcode.com/u/themohin' },
  ];
